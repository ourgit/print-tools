  ...
  <div :class="['tempate-box', {isEdit}]" :style="{'width':$calcStyle(100,templateData.ratio,'mm'),'height':$calcStyle(50,templateData.ratio,'mm'),'padding':$calcStyle(2,templateData.ratio,'mm')}">
    <div class="content" :style="{'height':$calcStyle(45,templateData.ratio,'mm')}">
      ...
      <div class="right-box">
        ...
        <div class="text-item" :style="{'height':$calcStyle(9,templateData.ratio,'mm'),'fontSize':$calcStyle(7,templateData.ratio,'pt')}" @click="updateItem('A006')">
          ...
          <div class="value" :style="{'height':$calcStyle(9,templateData.ratio,'mm')}">{{ templateData.showA006 ? templateData.A006 : ''}}</div>
        </div>
