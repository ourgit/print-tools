    ...
    <div class="content" :style="{'height':$calcStyle(45,templateData.ratio,'mm')}">
      ...
      <div class="right-box">
        ...
        <div class="text-inline" :style="{'height':$calcStyle(9,templateData.ratio,'mm')}">
          ...
          <div class="inline-item" :style="{'height':$calcStyle(9,templateData.ratio,'mm'),'fontSize':$calcStyle(7,templateData.ratio,'pt')}" @click="updateItem('A052')">
            <div class="label" :style="{'width':$calcStyle(10,templateData.ratio,'mm'),'height':$calcStyle(9,templateData.ratio,'mm')}">{{ templateData.showA052 ? templateData.A052Label : ''}}</div>
            <div class="value" :style="{'height':$calcStyle(9,templateData.ratio,'mm')}">{{ templateData.showA052 ? templateData.A052 : ''}}</div>
          </div>
        </div>
        <div class="text-inline" :style="{'height':$calcStyle(9,templateData.ratio,'mm')}">
          <div class="inline-item" :style="{'height':$calcStyle(9,templateData.ratio,'mm'),'fontSize':$calcStyle(7,templateData.ratio,'pt')}" @click="updateItem('A010')">
            ...
            <div class="value border-right" :style="{'height':$calcStyle(9,templateData.ratio,'mm')}">{{ templateData.showA010 ? templateData.A010 : ''}}</div>
          </div>
          <div class="inline-item" :style="{'height':$calcStyle(9,templateData.ratio,'mm'),'fontSize':$calcStyle(7,templateData.ratio,'pt')}" @click="updateItem('A902')">
            ...
            <div class="value" :style="{'height':$calcStyle(9,templateData.ratio,'mm')}">{{ templateData.showA902 ? templateData.A902 : ''}}</div>
          </div>
        </div>
        <div class="text-item last" :style="{'height':$calcStyle(9,templateData.ratio,'mm'),'fontSize':$calcStyle(7,templateData.ratio,'pt')}" @click="updateItem('A003')">
          <div class="label" :style="{'width':$calcStyle(10,templateData.ratio,'mm'),'height':$calcStyle(9,templateData.ratio,'mm')}">{{ templateData.showA003 ? templateData.A003Label : ''}}</div>
          <div class="value" :style="{'height':$calcStyle(9,templateData.ratio,'mm')}">{{ templateData.showA003 ? templateData.A003 : ''}}</div>
        </div>
      </div>
    </div>
  </div>
